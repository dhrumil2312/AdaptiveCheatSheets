...
(function (U, ca, p) {
    ...
    function gc(b, a) {
        var c = 0, d;
        if (J(b) || F(b)) return b.length; else if (L(b)) for (d in b) (!a || b.hasOwnProperty(d)) && c++;
        return c
    }
    ...
    function V(b, a) {
        ...
        } else (a = b) && (J(b) ? a = V(b, []) : na(b) ? a = new Date(b.getTime()) : L(b) && (a = V(b, {})));
        return a
    }
    ...
    function tb(b, a, c) {
        ...
        $(b, "handle") && (t(a) ? m(d, function (a, c) {
            db(b, c, a);
            delete d[c]
        }) : t(c) ? (db(b, a, d[a]), delete d[a]) : Ua(d[a], c))
    }
    ...
    function ub(b, a, c) {
        var d = $(b, "data"), e = v(c), g = !e && v(a), i = g && !L(a);
        !d && !i && $(b, "data", d = {});
    ...
    function pc(b, a) {
        var c = function (c, e) {
            ...
            if (!c.target) c.target = c.srcElement || ca;
    ...
    function Ab(b) {
        ...
        } else J(b) ? (c = b.length - 1, ra(b[c], "fn"), a = b.slice(0, c)) : ra(b, "fn", !0);
        return a
    }
    ...
    function qb(b) {
        ...
        function g(a, b) {
            ...
            function d(a, b, e) {
                var f = [], k = Ab(a), g, n, i;
                n = 0;
                for (g = k.length; n < g; n++) i = k[n], f.push(e && e.hasOwnProperty(i) ? e[i] : c(i, h));
                a.$inject || (a = a[g]);
                switch (b ? -1 : f.length) {
                    case 0:
                        return a();
    ...
    function vc(b, a, c, d) {
        ...
        f.onUrlChange = function (a) {
            K || (d.history && u(b).bind("popstate", i), d.hashchange ? u(b).bind("hashchange", i) : f.addPollFn(i), K = !0);
            A.push(a);
            return a
        };
        f.baseHref = function () {
        ...
        f.cookies = function (a, b) {
            ...
            if (a) if (b === p) h.cookie = escape(a) + "=;path=" + M + ";expires=Thu, 01 Jan 1970 00:00:00 GMT"; else {
                ...
                if (h.cookie !== y) {
                    ...
                    d = y.split("; ");
                    W = {};
                    for (f = 0; f < d.length; f++) e = d[f], k = e.indexOf("="), k > 0 && (W[unescape(e.substring(0, k))] = unescape(e.substring(k + 1)))
                }
                return W
            }
        };
    ...
    function xc() {
        this.$get = function () {
            function b(b,
                ...
                if (b in a) throw B("cacheId " + b + " taken");
                var i = 0, f = x({}, d, {id: b}), h = {}, k = d && d.capacity || Number.MAX_VALUE, j = {}, l = null,
                    o = null;
                return a[b] = {
                    put: function (a, b) {
                        var c = j[a] || (j[a] = {key: a});
                        e(c);
                        t(b) || (a in h || i++, h[a] = b, i > k && this.remove(o.key))
                    }, get: function (a) {
                        var b = j[a];
                        if (b) return e(b), h[a]
                    }, remove: function (a) {
        ...
        this.directive = function f(d, e) {
            F(d) ? (qa(e, "directive"), a.hasOwnProperty(d) || (a[d] = [], b.factory(d + c, ["$injector", "$exceptionHandler", function (b, c) {
                ...
                m(a[d], function (a) {
                    try {
                        var f = b.invoke(a);
                        if (N(f)) f = {compile: I(f)}; else if (!f.compile && f.link) f.compile = I(f.link);
            ...
            "$http", "$templateCache", "$parse", "$controller", "$rootScope", function (b, h, k, j, l, o, r, n) {
                ...
                function s(a, b, c, d) {
                    function e(a, c, d, k) {
                        for (var g, h, j, n, o, l = 0, r = 0, q = f.length; l < q; r++) j = c[r], g = f[l++],
                            h = f[l++], g ? (g.scope ? (n = a.$new(L(g.scope)), u(j).data("$scope", n)) : n = a, (o = g.transclude) || !k && b ? g(h, n, j, d, function (b) {
                            return function (c) {
                                var d = a.$new();
                    ...
                    for (var f = [], k, g, h, j = 0; j < a.length; j++) g = new ea, k = O(a[j], [], g, d), g = (k = k.length ? C(k, a[j], g, b, c) : null) && k.terminal || !a[j].childNodes.length ? null : s(a[j].childNodes, k ? k.transclude : b), f.push(k), f.push(g), h = h || k || g;
                    return h ? e : null
                }
                ...
                function O(a, b, c, f) {
                    ...
                    switch (a.nodeType) {
                        case 1:
                            ...
                            var h, j, n;
                            g = a.attributes;
                            for (var o = 0, l = g && g.length; o < l; o++) if (h = g[o], h.specified) j = h.name, n = fa(j.toLowerCase()), k[n] = j, c[n] = h = R(aa && j == "href" ? decodeURIComponent(a.getAttribute(j, 2)) : h.value), yb(a, n) && (c[n] = !0), X(a, b, h, n), A(b, n, "A", f);
                            a = a.className;
                            if (F(a) && a !== "") for (; g = e.exec(a);) n = fa(g[2]), A(b, n, "C", f) && (c[n] = R(g[3])), a = a.substr(g.index + g[0].length);
                            break;
                        case 3:
                            H(b, a.nodeValue);
                            break;
                ...
                function C(a, b, c, d, e) {
                    function f(a, b) {
                        ...
                        if (b) b.require = z.require, ba.push(b)
                    }
                    ...
                    function j(a, d, e, f, g) {
                            ...
                            m(C.scope, function (a, b) {
                                ...
                                switch (c[1]) {
                                    ...
                                    case "&":
                                        ...
                                        break;
                                    default:
                                        throw B("Invalid isolate scope definition for directive " +
                                            C.name + ": " + a);
                                }
                            })
                        }
                        ...
                        f = 0;
                        for (w = ba.length; f < w; f++) try {
                            K = ba[f], K(d, q, n, K.require && h(K.require, q))
                        } catch (Ha) {
                            k(Ha, pa(q))
                        }
                    }
                    ...
                    for (var n = -Number.MAX_VALUE, l = [], ba = [], s = null, C = null, A = null, y = c.$$element = u(b), z, H, X, D, v = d, t, x, Y, E = 0, G = a.length; E < G; E++) {
                        ...
                        if (Y = z.scope) M("isolated scope", C, z, y), L(Y) && (q(y, "ng-isolate-scope"), C = z), q(y, "ng-scope"), s = s || z;
                        H = z.name;
                        if (Y = z.controller) t = t || {}, M("'" + H + "' controller", t[H], z, y), t[H] = z;
                        if (Y = z.transclude) M("transclusion", D, z, y), D = z, n = z.priority, Y == "element" ? (X = u(b), y = c.$$element = u("<\!-- " + H + ": " + c[H] + " --\>"), b = y[0], Ga(e, u(X[0]), b), v = w(X, d, n)) : (X = u(cb(b)).contents(), y.html(""), v = w(X, d));
                        if (Y = z.template) if (M("template", A, z, y), A = z, Y = Ha(Y), z.replace) {
                            X = u("<div>" + R(Y) + "</div>").contents();
                            b = X[0];
                            if (X.length != 1 || b.nodeType !== 1) throw new B(g + Y);
                            Ga(e, y, b);
                            H = {$attr: {}};
                        ...
                        if (z.templateUrl) M("template", A, z, y), A = z, j = W(a.splice(E, a.length - E), j, y, c, e, z.replace, v), G = a.length; else if (z.compile) try {
                ...
                function W(a, b, c, d, e,
                           f, k) {
                    var h = [], n, o, r = c[0], q = a.shift(),
                        w = x({}, q, {controller: null, templateUrl: null, transclude: null, scope: null});
                    c.html("");
                    j.get(q.templateUrl, {cache: l}).success(function (j) {
                        ...
                        for (o = s(c.contents(), k); h.length;) {
                            var ba = h.pop(), j = h.pop();
                            q = h.pop();
                            var y = h.pop(), m = l;
                            q !== r && (m = cb(l), Ga(j, u(q), m));
                            n(function () {
                                b(o,
                                    y, m, e, ba)
                            }, y, m, e, ba)
                ...
                ea.prototype = {
                    $normalize: fa, $set: function (a, b, c, d) {
                ...
                var D = h.startSymbol(), ba = h.endSymbol(), Ha = D == "{{" || ba == "}}" ? ma : function (a) {
    ...
    function va(b, a) {
        var c = Fb.exec(b), c = {
            protocol: c[1], host: c[3], port: G(c[5]) || Gb[c[1]] ||
    ...
    function Gc(b, a, c) {
        ...
        if (decodeURIComponent(d.path) == a) return b; else {
            ...
            if (d.path.indexOf(i) !== 0) throw B('Invalid url "' + b + '", missing path prefix "' + i + '" !');
    ...
    function Ic() {
        ...
        this.$get = ["$rootScope", "$browser", "$sniffer", "$rootElement", function (c, d, e, g) {
            ...
            a ? (h = d.baseHref() || "/", k = h.substr(0, h.lastIndexOf("/")), l = ka(l.protocol, l.host, l.port) + k + "/", f = e.history ? new gb(Fc(j, h, b), k, l) : new Hb(Gc(j, h, b), b, l, h.substr(k.length + 1))) : (l = ka(l.protocol, l.host, l.port) + (l.path || "") + (l.search ? "?" + l.search : "") + "#" + b + "/", f = new Ia(j, b, l));
            g.bind("click", function (a) {
                if (!a.ctrlKey && !(a.metaKey || a.which == 2)) {
                    for (var b = u(a.target); E(b[0].nodeName) !== "a";) if (b[0] === g[0] || !(b = b.parent())[0]) return;
    ...
    function Kc(b,
        ...
        function k() {
            for (var a = "", c = n; n < b.length;) {
                ...
                if (k == "." || e(k)) a += k; else {
                    var g = d();
                    if (k == "e" && f(g)) a += k; else if (f(k) && g && e(g) && a.charAt(a.length - 1) == "e") a += k; else if (f(k) && (!g || !e(g)) && a.charAt(a.length - 1) == "e") h("Invalid exponent"); else break
                }
                n++
            }
            a *= 1;
        ...
        function l(a) {
            ...
            for (var d = "", e = a, f = !1; n < b.length;) {
                var k = b.charAt(n);
                e += k;
                if (f) k == "u" ? (k = b.substring(n + 1, n + 5), k.match(/[\da-f]{4}/i) || h("Invalid unicode escape [\\u" + k + "]"), n += 4, d += String.fromCharCode(parseInt(k, 16))) : (f = Lc[k], d += f ? f : k),
                    f = !1; else if (k == "\\") f = !0; else if (k == a) {
                    n++;
                    o.push({
        ...
        for (var o = [], r, n = 0, w = [], q, s = ":"; n < b.length;) {
            ...
            if (c("\"'")) l(q); else if (e(q) || c(".") && e(d())) k(); else if (i(q)) {
                if (j(), "{,".indexOf(s) != -1 && w[0] == "{" && (r = o[o.length - 1])) r.json = r.text.indexOf(".") == -1
            } else if (c("(){}[].,;:")) o.push({
                index: n,
                text: q,
                json: ":[,".indexOf(s) != -1 && c("{[") || c("}]:,")
            }), c("{[") && w.unshift(q), c("}]") && w.shift(),
                n++; else if (g(q)) {
                n++;
                continue
            } else {
                var m = q + d(), C = Ka[q], A = Ka[m];
                A ? (o.push({index: n, text: m, fn: A}), n += 2) : C ? (o.push({
                    index: n,
                    text: q,
                    fn: C,
                    json: "[,:".indexOf(s) != -1 && c("+-")
    ...
    function Mc(b, a, c, d) {
        ...
        function C() {
            ...
            for (var c; b = f("(", "[", ".");) b.text === "(" ? (a = u(a, c), c = null) : b.text === "[" ? (c = a, a = ea(a)) : b.text === "." ? (c = a, a = t(a)) : e("IMPOSSIBLE");
            return a
        }
        ...
        var W = I(0), y, M = Kc(b, d), H = function () {
            ...
            for (var a = H(), b; ;) if (b = f("|")) a = j(a, b.fn, o()); else return a
        };
        a ? (H = r, u = t = ea = v = function () {
    ...
    function Qc() {
        ...
        this.$get = ["$rootScope", "$location", "$routeParams", "$q", "$injector", "$http", "$templateCache", function (a, c, d, e, g, i, f) {
            function h() {
                var b = k(), h = r.current;
                if (b && h && b.$route === h.$route && ha(b.pathParams, h.pathParams) && !b.reloadOnSearch && !o) h.params = b.params, V(h.params, d), a.$broadcast("$routeUpdate", h); else if (b ||
            ...
            e.prototype = {
                $new: function (a) {
                    ...
                    do {
                        ...
                        s = this;
                        do {
                            for (r = s.$$asyncQueue; r.length;) try {
                                s.$eval(r.shift())
                            } catch (K) {
                                c(K)
                            }
                            if (i = s.$$watchers) for (n = i.length; n--;) try {
                            ...
                            if (!(i = s.$$childHead || s !== this && s.$$nextSibling)) for (; s !== this && !(i = s.$$nextSibling);) s = s.$parent
                        } while (s = i);
        ...
        this.$get = ["$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function (a, b, c, h, k, j) {
            function l(a) {
                ...
                var e = a.transformRequest ||
                    d.transformRequest, f = a.transformResponse || d.transformResponse, h = d.headers,
                    h = x({"X-XSRF-TOKEN": b.cookies()["XSRF-TOKEN"]}, h.common, h[E(a.method)], a.headers),
                    e = Ob(a.data, Nb(h), e), g;
            ...
            function o(b, c, d) {
                ...
                function f(a, c, d) {
                    c = Math.max(c, 0);
                    (200 <= c && c < 300 ? j.resolve : j.reject)({data: a, status: c, headers: Nb(d), config: b})
                }
                ...
                if (m) if (p = m.get(w)) if (p.then) return p.then(i, i), p; else J(p) ? f(p[1], p[0], V(p[2])) : f(p, 200, {}); else m.put(w, o);
                p || a(b.method,
                    w, c, e, d, b.timeout, b.withCredentials);
                return o
            }
            ...
            function r(a, b) {
                ...
                var c = [];
                ec(b, function (a, b) {
                    a == null || a == p || (L(a) && (a = da(a)), c.push(encodeURIComponent(b) + "=" + encodeURIComponent(a)))
                });
    ...
    function $c() {
        this.$get = ["$rootScope", "$browser", "$q", "$exceptionHandler", function (b, a, c, d) {
            function e(e, f, h) {
                var k = c.defer(), j = k.promise, l = v(h) && !h, f = a.defer(function () {
                    try {
                        k.resolve(e())
                    } catch (a) {
                        k.reject(a), d(a)
    ...
    function Ub(b, a, c, d, e) {
        ...
        if (!k) {
            ...
            var i = Math.pow(10, e), b = Math.round(b * i) / i, b = ("" + b).split(Vb), i = b[0], b = b[1] || "", k = 0,
                j = a.lgSize, l = a.gSize;
            if (i.length >= j + l) for (var k = i.length - j, o = 0; o < k; o++) (k - o) % l === 0 && o !== 0 && (f += c), f += i.charAt(o);
            for (o = k; o < i.length; o++) (i.length - o) % j === 0 && o !== 0 &&
            (f += c), f += i.charAt(o);
            for (; b.length < e;) b += "0";
            e && (f += d + b.substr(0, e))
        }
    ...
    function Rb(b) {
        ...
        return function (c, e) {
            ...
            wa(c) && (c = new Date(c));
            if (!na(c)) return c;
            for (; e;) (h = gd.exec(e)) ? (i = i.concat(ia.call(h,
                1)), e = i.pop()) : (i.push(e), e = null);
            m(i, function (a) {
                f = hd[a];
    ...
    function Qa(b, a, c, d, e, g) {
        ...
        h && (h.match(/^\/(.*)\/$/) ?
            (h = RegExp(h.substr(1, h.length - 2)), e = function (a) {
                return k(h, a)
            }) : e = function (a) {
                var c = b.$eval(h);
                if (!c || !c.test) throw new B("Expected " + h + " to be a RegExp but was " + c);
                return k(c, a)
    ...
    var E = function (b) {
        ...
        }, B = U.Error, aa = G((/msie (\d+)/.exec(E(navigator.userAgent)) || [])[1]), u, ja, ia = [].slice, Ra = [].push,
        Sa = Object.prototype.toString, Yb = U.angular || (U.angular = {}), ta, Cb, Z = ["0", "0", "0"];
    D.$inject = [];
    ma.$inject = [];
    Cb = aa < 9 ? function (b) {
        b = b.nodeName ? b : b[0];
    ...
    var kc = /[A-Z]/g, id = {full: "1.0.3", major: 1, minor: 0, dot: 3, codeName: "bouncy-thunder"}, Ba = Q.cache = {},
        ...
        }, mc = /([\:\-\_]+(.))/g, nc = /^moz([A-Z])/, ua = Q.prototype = {
            ready: function (b) {
                function a() {
                    c || (c = !0, b())
                }
    ...
    m({
        data: ub, inheritedData: Da, scope: function (b) {
            ...
            var d = E(a);
            if (Ea[d]) if (v(c)) c ? (b[a] = !0, b.setAttribute(a, d)) : (b[a] = !1, b.removeAttribute(d)); else return b[a] || (b.attributes.getNamedItem(a) || D).specified ? d : p; else if (v(c)) b.setAttribute(a,
    ...
    m({
        removeData: sb, dealoc: sa, bind: function a(c, d, e) {
            var g = $(c, "events"), i = $(c, "handle");
            g || $(c, "events", g = {});
            i || $(c, "handle", i = pc(c, g));
        ...
        }, addClass: wb, removeClass: vb, toggleClass: function (a,
                                                                 c, d) {
            t(d) && (d = !Ca(a, c));
            (d ? wb : vb)(a, c)
        }, parent: function (a) {
        ...
        Q.prototype[c] = function (c, e) {
            for (var g, i = 0; i < this.length; i++) g == p ? (g = a(this[i], c, e), g !== p && (g = u(g))) : bb(g, a(this[i], c, e));
            return g == p ? this : g
        }
    });
    Fa.prototype = {
    ...
    var rc = /^function\s*[^\(]*\(\s*([^\)]*)\)/m, sc = /,/, tc = /^\s*(_?)(\S+?)\1\s*$/,
        qc = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/mg, Db = "Non-assignable model expression: ";
    Bb.$inject = ["$provide"];
    var Ac = /^(x[\:\-_]|data[\:\-_])/i,
        Fb = /^([^:]+):\/\/(\w+:{0,1}\w*@)?([\w\.-]*)(:([0-9]+))?(\/[^\?#]*)?(\?([^#]*))?(#(.*))?$/,
        ...
        restrict: "E", compile: function (a, c) {
            ...
            return function (a, c) {
                c.bind("click", function (a) {
                    if (!c.attr("href")) return a.preventDefault(), !1
                })
            }
        }
    }), kb = {};
    ...
    var Ra = function (a) {
        ...
        nd = /^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,4}$/, od = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/,
        ac = {
            text: Qa, number: function (a, c, d, e, g, i) {
                Qa(a, c, d, e, g, i);
            ...
            return {
                restrict: "E", require: "?ngModel", link: function (d, e, g, i) {
                    i && (ac[E(g.type)] || ac.text)(d, e, g, i, c, a)
                }
            }
        }], Na = "ng-valid", Ma = "ng-invalid", Pa = "ng-pristine", Xb = "ng-dirty",
        ...
        }], yd = jb("", !0), zd = jb("Odd", 0), Ad = jb("Even", 1), Bd = S({
    ...
    var Ed = S(function (a, c, d) {
            ...
            var d = /{}/g;
            return {
                restrict: "EA", link: function (e, g, i) {
                    var f = i.count, h = g.attr(i.$attr.when), k = i.offset || 0, j = e.$eval(h), l = {},
                        o = c.startSymbol(), r = c.endSymbol();
                    m(j, function (a, e) {
                    ...
                    a.$watch(function (a) {
                        ...
                        for (f = v.length; e < f; e++) {
                            ...
                            if (t = l.shift(A)) {
                                p = t.scope;
                                u.push(A, t);
                                if (e !== t.index) t.index = e, y.after(t.element);
                                y = t.element
                            } else p = a.$new();
                            p[k] = A;
                            j && (p[j] = C);
            ...
            controller: ["$transclude", "$element", function (a,
                                                              c) {
                a(function (a) {
                    c.append(a)
                })
            ...
            return {
                restrict: "E", require: ["select",
                    ...
                    function k(a, c, d, e) {
                        d.$render = function () {
                            var a = d.$viewValue;
                            e.hasOption(a) ? (A.parent() && A.remove(), c.val(a), a === "" && s.prop("selected", !0)) : t(a) && s ? c.val("") : e.renderUnknownOption(a)
                        };
                    ...
                    function l(e, f, g) {
                        function h() {
                            ...
                            u = !1;
                            var z, B;
                            if (n) u = new Fa(s); else if (s === null || q) a[""].push({
                                selected: s === null,
                                id: "",
                                label: ""
                            }), u = !0;
                            ...
                            !n && !u && a[""].unshift({id: "?", label: "", selected: !0});
                            w = 0;
                            for (y = c.length; w < y; w++) {
                                ...
                                if (v.length <= w) s = {
                                    ...
                                    label: i.label
                                }, t = [s], v.push(t), f.append(s.element); else if (t = v[w], s = t[0], s.label != d) s.element.attr("label", s.label = d);
                                z = null;
                                x = 0;
                                for (A = i.length; x < A; x++) if (d = i[x], u = t[x + 1]) {
                                    z = u.element;
                                    if (u.label !== d.label) z.text(u.label = d.label);
                                    if (u.id !== d.id) z.val(u.id = d.id);
                                    if (u.element.selected !==
                                        d.selected) z.prop("selected", u.selected = d.selected)
                                } else d.id === "" && q ? B = q : (B = D.clone()).val(d.id).attr("selected", d.selected).text(d.label), t.push({
                                    element: B,
                                    label: d.label,
                                    id: d.id,
                                    selected: d.selected
                                }), z ? z.after(B) : s.element.append(B), z = B;
                        ...
                        var j = c(i[2] || i[1]), k = i[4] ||
                            i[6], l = i[5], m = c(i[3] || ""), o = c(i[2] ? i[1] : k), r = c(i[7]),
                            v = [[{element: f, label: ""}]];
                    ...
                    if (h[1]) {
                        for (var o =
                            h[0], r = h[1], n = f.multiple, w = f.ngOptions, q = !1, s, D = u(ca.createElement("option")), C = u(ca.createElement("optgroup")), A = D.clone(), h = 0, x = i.children(), E = x.length; h < E; h++) if (x[h].value == "") {
                            s = q = x.eq(h);
                            break
                        }
                        o.init(r, q, A);
    ...
    }), ab("remove", !0), ab("empty"), ab("html")) : u = Q;
    Yb.element = u;
    (function (a) {
        x(a, {
            bootstrap: pb,
